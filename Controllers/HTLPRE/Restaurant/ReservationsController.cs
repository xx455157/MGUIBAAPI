...
namespace MGUIBAAPI.Controllers.HTLPRE.Restaurant
{
	...
	public class ReservationsController : GUIAppAuthController
    {
        #region " 私用屬性 "
        ...
        /// 商業邏輯物件屬性
        /// </summary>
        private BlHTPP BlHTPP => new BlHTPP(ClientContent);
        ...
        [HttpGet("table")]
		public IEnumerable<MdTableGroup> GetPosDateTableData([RequiredFromQuery] string posId,
            [RequiredFromQuery] string posDate)
		{
			return BlHTPP.GetPosDateTableData(posId, posDate);
		}
