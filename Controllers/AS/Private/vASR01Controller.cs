...
namespace MGUIBAAPI.Controllers.AS
{
	...
	public class vASR01Controller : GUIAppAuthController
    {
        ...
        /// 商業邏輯物件屬性
        /// </summary>
        private BlASR01 BlASR01 => new BlASR01(ClientContent);
        ...
        {
            return BlASR01.GetSYSDefault(companies);
        }
        ...
        public MdASR01_p Q_GetList([FromBody] MdDepreciation_q queryParams, [DARange(1, int.MaxValue)] int pageNo, int rowsPerPage = 0)
        {
            return BlASR01.Q_GetList(queryParams, ControlName, pageNo, ref rowsPerPage);
        }
        ...
        [HttpPost("report")]
        public async Task<IActionResult> GetReport([FromBody] MdReportQuery<MdDepreciation_q> obj)
        {
            // 建立報表
            var _info = await BlASR01.GetReport(obj, false);
