...
using GUIStd.DAL.AllNewAS.Models.Private.vASR10;
using GUIStd.DAL.AllNewAS.Models.Private.Allocation;
...
{
    /// <summary>
    /// vASR10固定資產調撥更程式資料控制器
    /// </summary>
    [Route("as/private/[controller]")]
    public class vASR10Controller : GUIAppAuthController
    {
        #region " 私用屬性 "
        ...
        /// 商業邏輯物件屬性
        /// </summary>
        private BlASR10 BlASR10 => new BlASR10(ClientContent);
        ...
        [HttpGet("page")]
        public MdASR10_h GetUIData()
        {
            return BlASR10.GetUIData();
        }
        ...
        {
            return BlASR10.GetSYSDefault(companies);
        }
        ...
        public MdASR10_p Q_GetList([FromBody] MdAllocation_q queryParams, [DARange(1, int.MaxValue)] int pageNo, int rowsPerPage = 0)
        {
            return BlASR10.Q_GetList(queryParams, ControlName, pageNo, ref rowsPerPage);
        }
        ...
        [HttpPost("report")]
        public async Task<IActionResult> GetReport([FromBody] MdReportQuery<MdAllocation_q> obj)
        {
            // 建立報表
            var _info = await BlASR10.GetReport(obj, false);
