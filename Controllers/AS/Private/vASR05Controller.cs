...
namespace MGUIBAAPI.Controllers.AS
{
    ...
    public class vASR05Controller : GUIAppAuthController
    {
        #region " 私用屬性 "
        ...
        /// 商業邏輯物件屬性
        /// </summary>
        private BlASR05 BlASR05 => new BlASR05(ClientContent);
        ...
        [HttpGet("page")]
        public MdASR05_h GetUIData()
        {
            return BlASR05.GetUIData();
        }
        ...
        {
            return BlASR05.GetSYSDefault(companies);
        }
        ...
        public MdASR05_p Q_GetList([FromBody] MdRetirement_q queryParams, [DARange(1, int.MaxValue)] int pageNo, int rowsPerPage = 0)
        {
            return BlASR05.Q_GetList(queryParams, ControlName, pageNo, ref rowsPerPage);
        }
        ...
        [HttpPost("report")]
        public async Task<IActionResult> GetReport([FromBody] MdReportQuery<MdRetirement_q> obj)
        {
            // 建立報表
            var _info = await BlASR05.GetReport(obj, false);
