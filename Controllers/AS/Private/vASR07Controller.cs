...
using GUIStd.DAL.AllNewAS.Models.Private.vASR07;
...
namespace MGUIBAAPI.Controllers.AS
{
    ...
    public class vASR07Controller : GUIAppAuthController
    {
        #region " 私用屬性 "
        ...
        /// 商業邏輯物件屬性
        /// </summary>
        private BlASR07 BlASR07 => new BlASR07(ClientContent);
        ...
        [HttpGet("page")]
        public MdASR07_h GetUIData()
        {
            return BlASR07.GetUIData();
        }
        ...
        {
            return BlASR07.GetSYSDefault(companies);
        }
        ...
        public MdASR07_p Q_GetList([FromBody] MdMaintain_q queryParams, [DARange(1, int.MaxValue)] int pageNo, int rowsPerPage = 0)
        {
            return BlASR07.Q_GetList(queryParams, ControlName, pageNo, ref rowsPerPage);
        }
        ...
        [HttpPost("report")]
        public async Task<IActionResult> GetReport([FromBody] MdReportQuery<MdMaintain_q> obj)
        {
            // 建立報表
            var _info = await BlASR07.GetReport(obj, false);
