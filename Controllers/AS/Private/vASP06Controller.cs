...
using GUIStd.DAL.AllNewAS.Models.Private.vASP06;
...
{
    /// <summary>
    /// vASP06財產費用分攤系統程式資料控制器
    /// </summary>
    [Route("as/private/[controller]")]
	public class vASP06Controller : GUIAppAuthController
    {
        #region " 私用屬性 "
        ...
        [HttpGet("page")]
        [HttpGet("paged")]
        public MdASP06_h GetUIData()
        {
            return BlApportionment.GetASP06_UiData();
        }
