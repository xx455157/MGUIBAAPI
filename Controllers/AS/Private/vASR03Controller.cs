...
namespace MGUIBAAPI.Controllers.AS
{
	...
	public class vASR03Controller : GUIAppAuthController
    {
        #region " 私用屬性 "
        ...
        /// 商業邏輯物件屬性
        /// </summary>
        private BlASR03 BlASR03 => new BlASR03(ClientContent);
        ...
        [HttpGet("page")]
        public MdASR03_h GetUIData()
        {
            return BlASR03.GetUIData();
        }
        ...
        {
            return BlASR03.GetSYSDefault(companies);
        }
        ...
        public MdASR03_p Q_GetList([FromBody] MdPurchased_q queryParams, [DARange(1, int.MaxValue)] int pageNo, int rowsPerPage = 0)
        {
            return BlASR03.Q_GetList(queryParams, ControlName, pageNo, ref rowsPerPage);
        }
        ...
        [HttpPost("report")]
        public async Task<IActionResult> GetReport([FromBody] MdReportQuery<MdPurchased_q> obj)
        {
            // 建立報表
            var _info = await BlASR03.GetReport(obj, false);
