...
namespace MGUIBAAPI.Controllers.AS
{
	...
	public class vASR03Controller : GUIAppAuthController
    {
        ...
        public MdASR03_p Q_GetList([FromBody] MdPurchased_q queryParams, [DARange(1, int.MaxValue)] int pageNo)
        {
            return BlASR03.Q_GetList(queryParams, ControlName, pageNo);
        }
